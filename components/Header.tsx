...
export default function Header() {
  return (
    <header className="pt-12 pb-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-6">
      <Link href="/" className="text-center sm:text-left cursor-pointer group">
      ...
      <div className="flex items-center gap-8">
        ...
        <Link
          href="/about"
          className="text-stone-500 hover:text-walnut transition-colors font-serif tracking-widest text-sm flex items-center gap-2"
        >
          关于
        </Link>
        ...
        <Link
          href="/upload"
          className="hover:text-walnut transition-colors p-1 text-stone-400"
          title="上传珍品"
          aria-label="上传珍品"
        >
